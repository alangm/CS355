...
public class Draw {
	...
	public void draw(Shape shape, boolean selected) {
        ...
        t.translate(shape.getCenter().getX(), shape.getCenter().getY());
        t.rotate(shape.getRotation());

        g2d.setTransform(objToView);	// Set the magic into the graphics object
    ...
    public void drawWireFrame(WireFrame model) {
        ...
        g2d.setTransform(view.worldToView);
